...
def main():
    ...
    for i,o in enumerate(options):
        ...
        tu_get_detection_probabilities(model, interactor, file_path, ex_t, iterations_per_test=5000, budget=3, probability_schedules=probability_schedules[i], path=f"experiments/probabilities_{o}.txt")
